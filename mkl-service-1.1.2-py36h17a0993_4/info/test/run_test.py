#  tests for mkl-service-1.1.2-py36h17a0993_4 (this is a generated file);
print('===== testing package: mkl-service-1.1.2-py36h17a0993_4 =====');
...
print('===== mkl-service-1.1.2-py36h17a0993_4 OK =====');
print("import: 'mkl'")
import mkl
